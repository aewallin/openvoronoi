...
void VoronoiDiagram::add_separator(HEFace f, HEFace null_face, HEVertex sep_endp, Site* s1, Site* s2) {
    if (debug) {
    ...
    bool out_new_in;
    boost::tie(v_previous,v_target,v_next, out_new_in) = find_separator_target(f,sep_endp);
