...
# better.
mencoder mf://frames/*.png -mf fps=2:type=png  -aspect 16:9 -of lavf -ovc lavc -lavcopts aglobal=1:vglobal=1:coder=0:vcodec=mpeg4:vbitrate=4500 -vf scale=1920:1080 -ofps 2000/1001 -o frames/OUTPUT3.mp4
